...
DATABASES = {
    'default': {
        ...
        'NAME': 'my_app_db',  # Use your actual database name
        #'NAME': 'my_db',
        'USER': 'data',  # Your PostgreSQL username
        'PASSWORD': 'Henok@934',  # Your PostgreSQL password
        'HOST': 'my_db.oregon.render.com',  # Use your actual Render host
        ...
        #'HOST': 'db.my_db.<region>.render.com',  # Replace <region> with your actual region
        'PORT': '5432',  # Set to empty string for default
        'HOST': 'my_app_db.oregon.render.com',  # Use your actual Render host
    }
}
"""
